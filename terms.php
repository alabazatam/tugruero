        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
					<h2 class="text-center white-font big_title"><b class="white-font big_title">Términos y condiciones<br>TU/GRUERO®</b></h2>
					</br>
					<h3 class="text-left white-font extra_bold">Compañias de Seguro</h3>
					<p class="text-justify white-font extra_bold">
                                            <a class="white-font" href="<?php echo full_url?>/web/terms/Términos y Condiciones TUGRUERO® - Universal de Seguros, C.A..pdf" target="_blank"><i class="fa fa-file-pdf-o fa-3x"></i> Términos y condiciones TU/GRUERO® - Compañias de Seguro</a>
                                        </p>
                                        </br>
					<h3 class="text-left white-font extra_bold">Clientes particulares no asegurados</h3>
					<p class="text-justify white-font extra_bold">
                                            <a class="white-font" href="<?php echo full_url?>/web/terms/Términos y Condiciones TUGRUERO® - PARTICULARES.pdf" target="_blank"><i class="fa fa-file-pdf-o fa-3x"></i> Términos y condiciones TU/GRUERO® - Clientes particulares no asegurados</a>
                                        </p> 
                                        </br>
					<h3 class="text-left white-font extra_bold">Planes TU/GRUERO® Básico, TU/GRUERO® Plus y TU/GRUERO® Gold</h3>
					<p class="text-justify white-font extra_bold">
                                            <a class="white-font " href="<?php echo full_url?>/web/terms/terminos_basico.pdf" target="_blank"><i class="fa fa-file-pdf-o fa-3x"></i> Plan TU/GRUERO® Básico</a>
											<br>
											<br>
