...
<script src="<?php echo full_url;?>/web/js/mercadopago_adeseguro.js"></script>
</head>
...
<nav class="navbar navbar-default" >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"></div>
		...
		<div class="text-center col-sm-12 mercadopagodiv well well-sm text-danger">
		<h1 class="text-center">
			...
			<div class="">
				<div class="col-sm-12 text-center">
					<a class="text-center" href="#"><img class="text-center" src="<?php echo full_url;?>/web/img/fresh/asesor-seguros.png" alt=""></a>
                </div>  

            </div>
<div class="col-sm-8 col-sm-offset-2" id="mercadopagodiv">
    <form action="" method="post" id="pay" name="pay" class="">
	<div class="form-group col-sm-12 well well-sm text-danger">
		<p class="subtitulo_planes_jleal"><strong>Datos del producto</strong></p>
	</div>
      <div class="form-group col-sm-8">
		  <label for="descripcion" class="control-label">Descripción del producto</label> <label class="text-danger"> * </label>

        <div class="">
			<input type="text" class="form-control" required id="descripcion" name="descripcion" value="<?php if(isset($values['descripcion']) and $values['descripcion']!='') echo $values['descripcion'];?>">
        </div>
      </div>
	...
	<div class="form-group col-sm-12 well well-sm text-danger">
      ...
      <div class="form-group col-sm-8">
        ...
        <div class="">
            <input required type="number" class="form-control" autocomplete="off" data-checkout="docNumber" id="docNumber" maxlength="8" value="" placeholder="Ejemplo: 12345678"> 
        </div>
      </div>
      <div class="form-group col-sm-12">
        <label for="email" class="control-label">Correo electrónico</label> <label class="text-danger"> * </label>
        <div class="">
            <input required type="email" class="form-control" autocomplete="off" id="email" maxlength="" value="<?php if(isset($values['Correo']) and $values['Correo']!='') echo $values['Correo'];?>" placeholder="Ejemplo: correo@gmail.com">
        </div>
      </div>
      <div class="form-group col-sm-8">
      ...
      <div class="form-group col-sm-4">
        ...
        <div class="">
            <input required type="number" class="form-control" data-checkout="securityCode" autocomplete="off" id="securityCode" maxlength="3" value="" placeholder="Ejemplo: 123">
