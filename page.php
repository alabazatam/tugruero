        ...
        <form name="sentMessage" id="contactForm" class="form-horizontal">
          ...
          <div class="form-group" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 container">
                    <select size="8" class="form-control input_contact selectpicker" id="subject" name="subject" placeholder="" required data-validation-required-message="Por favor seleccione el asunto.">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <!--<input type="text" class="form-control input_contact" id="message" placeholder="" required data-validation-required-message="Por favor indique su Mensaje">-->
            </div>
          </div>
          <div id="success"></div>
          <div class="row">
