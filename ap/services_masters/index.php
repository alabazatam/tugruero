		...
		if(count($services_masters_list_json)>0)
		{
			foreach ($services_masters_list_json as $services_masters) 
			{
				...
				$array_json['data'][] = array(
					"idGrua" => $idGrua,
					"NombresApellidos" => $services_masters['nombre']." ".$services_masters['apellido'],
					"IdSolicitud" => $services_masters['idsolicitud'],
			...
			$array_json['data'][0] = array("idGrua"=>null,"NombresApellidos"=>"","IdSolicitud" => "","TimeInicio"=>"","TimeFin"=>"","EstatusCliente"=>"","EstatusGrua"=>"","Motivo"=>"","actions"=>"");
		}
