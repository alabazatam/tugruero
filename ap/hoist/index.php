			...
			foreach ($hoist_list_json as $hoist) 
			{
				...
				$array_json['data'][] = array(
					...
					"actions" => 
                                       ...
                                       .'<a class="btn btn-default btn-sm" href="'.full_url.'/ap/services_operator/index.php?action=index&idGrua='.$id_hoist.'&id_user='.$id_hoist.'"><i class="fa fa-book  fa-pull-left fa-border"></i></a>  '
										.'</form>'
					);	
			}		
		}else{
