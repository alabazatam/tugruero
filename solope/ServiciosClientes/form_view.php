...
<div class="container">
	...
	<div class="form-group">
		...
		<a class="btn btn-default"  href="<?php echo full_url."/solope/ServiciosClientes/index.php?idPoliza=".$values['idpoliza']?>"><i class="fa fa-arrow-left  fa-pull-left fa-border"></i> Regresar</a>
