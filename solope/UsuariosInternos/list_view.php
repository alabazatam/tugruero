...
<div class="container">
	...
	<a class="btn btn-default"  href="<?php echo full_url."/solope/UsuariosInternos/index.php?action=new"?>"><i class="fa fa-file-o fa-pull-left fa-border"></i>Agregar</a>
</div>
...
$(document).ready(function() {
    ...
    var table = $('#example').DataTable({
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo full_url."/solope/UsuariosInternos/index.php?action=list_json"?>",
		"language": {
