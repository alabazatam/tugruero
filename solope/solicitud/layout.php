...
<head>
    ...
    <link href="http://localhost/tugruero/web/css/bootstrap.css" rel="stylesheet">
...
<body>
    ...
    <!-- /#wrapper -->
    <!-- jQuery -->
	<script src="http://localhost/tugruero/web/js/jquery.js"></script>
	<script src="http://localhost/tugruero/web/js/bootstrap.min.js"></script>
    <script src="sidebar_menu.js"></script>
</body>
</html>