    ...
    class PDFPagos{
       ...
       public function cuadroRCVAsistir($values){
			...
			$html = '<table width="100%">'
                                ...
                                . '<td colspan="3" style="border-top-width:1px;">02-30521</td>'
                                . '<td colspan="2" style="border-top-width:1px;">No de Recibo:</td>'
                                . '<td style="border-top-width:1px;">9900005253</td>'
                                ...
                                . '<td colspan="7">THAIS ANDREINA, MONTES SALAZAR</td>'
                                ...
                                . '<td style="border-right-width:1px;">04143377838</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="2" style="border-left-width:1px;"> Dirección del Tomador:</td>'
                                . '<td colspan="9" style="border-right-width:1px;">AV. LOS ROBLES, CALLE BOLIVAR, CASA N° 2, CATIA . Apto: .</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="2" style="border-left-width:1px;"> Asegurado:</td>'
                                . '<td colspan="6">THAIS ANDREINA, MONTES SALAZAR</td>'
                                . '<td colspan="2">Rif/C.I:</td>'
                                . '<td style="border-right-width:1px;">14261823</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="2" style="border-left-width:1px;"> Dirección del Asegurado:</td>'
                                . '<td colspan="6">AV. LOS ROBLES, CALLE BOLIVAR, CASA N° 2, CATIA . Apto: .</td>'
                                . '<td colspan="2">Teléfono:</td>'
                                . '<td style="border-right-width:1px;">04143377838</td>'
                                . '</tr>'
                                . '<tr>'
