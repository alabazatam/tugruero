    ...
    class PDFPagos{
        ...
        public function cuadroTUGRUERO($values){
			...
			$html = '<table width="100%" border="0">'
                                ...
                                . '</tr>'
                                . '<tr>'
                                . '<td  style="border-style: solid; border-left-width: 1px">NOMBRE:</td>'
                                ...
                                . '<td colspan="" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.strtoupper($datos_cuadro['EstadoCivil']).'</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td  style="border-style: solid; border-left-width: 1px; border-top-width: -1px;">TELEFONO:</td>'
								...
								. '<td></td>'
                                . '<td>SEXO:</td>'
                                . '<td colspan="" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.strtoupper($datos_cuadro['Sexo']).'</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td  style="border-style: solid; border-left-width: 1px; border-top-width: 1px;">DOMICILIO:</td>'
                                . '<td style="border-style: solid; border-left-width: -1px; border-top-width: 1px;"></td>'
                                . '<td style="border-style: solid; border-left-width: -1px; border-top-width: 1px;">ESTADO:</td>'
                                . '<td style="border-style: solid; border-left-width: -1px; border-top-width: 1px;">'.strtoupper($datos_cuadro['Estado']).'</td>'
                                . '<td style="border-style: solid; border-left-width: -1px; border-top-width: 1px;" colspan="2">CIUDAD:</td>'
                                . '<td colspan="3" style="border-style: solid; border-left-width: -1px; border-top-width: 1px;; border-right-width: 1px;">'.$datos_cuadro['Ciudad'].'</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td  style="border-style: solid; border-left-width: 1px; border-top-width: -1px;">DIRECCION: </td>'
                                . '<td colspan="8" style="border-style: solid; border-left-width: -1px; border-top-width: -1px;; border-right-width: 1px;">'.$datos_cuadro['Domicilio'].'</td>'
                                . '</tr>'
                                . '<tr>'
                                ...
                                . '</tr>'
                                . '<tr>'
                                . '<td  style="border-style: solid; border-left-width: 1px">MARCA:</td>'
                                ...
                                . '<td>AÑO:</td>'
                                . '<td colspan="2" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.$datos_cuadro['Anio'].'</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td  style="border-style: solid; border-left-width: 1px; border-top-width: -1px;">PLACA:</td>'
                                . '<td COLSPAN="3">'.$datos_cuadro['Placa'].'</td>'
                                . '<td>TIPO:</td>'
                                . '<td COLSPAN="4" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.$datos_cuadro['Tipo'].'</td>'
                                . '</tr>'
                                . '<tr>'
                                ...
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="2"  style="border-style: solid; border-left-width: 1px; border-top-width: -1px;">NOMBRE PRODUCTO:</td>'
                                . '<td COLSPAN="2">'.$datos_cuadro['concatenado_plan'].'</td>'
                                . '<td>COSTO:</td>'
                                . '<td>'.$datos_cuadro['TotalConIva'].'</td>'
                                . '<td colspan="">INICIO VIG.</td>'
                                . '<td colspan="2" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.$datos_cuadro['VigenciaDesde'].'</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="2" style="border-style: solid; border-left-width: 1px; border-top-width: -1px;">CANTIDAD DE SERVICIOS:</td>'
                                . '<td COLSPAN="4">'.$datos_cuadro['CantidadServicios'].'</td>'
                                . '<td>FIN VIG.</td>'
                                . '<td colspan="2" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.$datos_cuadro['VigenciaHasta'].'</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td  colspan="3" style="border-style: solid; border-left-width: 1px; border-top-width: -1px;">TIPO DE SERVICIOS DE GRUA:</td>'
                                . '<td COLSPAN="2"> '.$datos_cuadro['TipoServicio'].'</td>'
                                . '<td colspan="2">KILOMETRAJE:</td>'
                                . '<td colspan="2" style="border-style: solid; border-right-width: 1px; border-top-width: -1px;">'.$datos_cuadro['Kilometraje'].'</td>'
                                . '</tr>'
                                . '<tr>'
       ...
       public function cuadroRCV($values){
			...
			$html = '<table width="100%" border="1">'
                                ...
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="9">DATOS VEHÍCULO</td>'
                                . '</tr>'
                                . '<tr>'
                                . '<td>MARCA:</td>'
                                . '<td></td>'
                                ...
                                . '</tr>'
                                . '<tr>'
                                . '<td colspan="9">DESCRIPCIÓN DEL PRODUCTO</td>'
                                . '</tr>'
                                . '<tr>'
