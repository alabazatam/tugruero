...
updateDisponible($link, $idGrua, $disponible,$uuid);


//------------------------------
//Actualizando la Disponibilidad
//------------------------------
function updateDisponible($link, $idGrua, $disponible,$uuid) {
    $Tabla = "Gruas";
    $LastUpdate = date(gmdate('Y-m-d H:i:s', time() - (4 * 3600)));

    $result = $link->query("UPDATE $Tabla SET Disponible = '$disponible',"
            . "LastUpdate = '$LastUpdate', DeviceID = '$uuid' WHERE idGrua = '$idGrua'");
