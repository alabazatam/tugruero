...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        $('#datetimepicker1,#datetimepicker2,#datetimepicker3,#datetimepicker4,#datetimepicker5,#datetimepicker6,#desde,#hasta,#FechaSolicitud,#VigenciaDesde,#VigenciaHasta').datetimepicker({
			 viewMode: 'days',
			 locale: 'es',
			 format: 'DD/MM/YYYY',
			 //useCurrent: true,
